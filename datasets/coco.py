...
def build_dataset(config, mode='training'):
    if mode == 'training':
        ...
        print(f"directory: {train_file}")  # 打印目录路径
        #train_file = "D:/new desktop_/GraduationProject/demos/catr-master/coco/annotations/captions_train2017.json"
        ...
        val_file.replace('\\','/')
        #val_file = "D:/new desktop_/GraduationProject/demos/catr-master/coco/annotations/captions_val2017.json"
